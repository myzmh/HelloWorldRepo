...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/张梦寒/PrivateHelloWorld'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '张梦寒' => 'zhangmenghan.213@bytedance.com' }
  s.source           = { :git => 'https://github.com/张梦寒/PrivateHelloWorld.git', :tag => s.version.to_s }
