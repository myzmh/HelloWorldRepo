...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/myzmh/HelloWorldRepo'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'zmh' => '1424649620@qq.com' }
  s.source           = { :git => 'https://github.com/myzmh/HelloWorldRepo.git', :tag => s.version.to_s }
